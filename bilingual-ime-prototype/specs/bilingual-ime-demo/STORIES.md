...
- Chinese and secondary-language text inside the same bilingual group stay close together.
- Separate bilingual groups, including groups created by Enter, stay at a fixed 28 px visual gap and are not stretched by unused editor height.
